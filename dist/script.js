  ...
  _createClass(Form, [{
    ...
    value: function createRequest() {
      ...
      fetch('./assets/server.php', {
        ...
        console.log(data);
        _this.btn.innerHTML = 'Succsess!';
        _this.btn.style.backgroundColor = '#9ec73d';
      }).catch(function (error) {
        console.log(error);
        _this.btn.innerHTML = 'Error';
        _this.btn.style.backgroundColor = '#d52b1e';
      }).finally(setTimeout(function () {
        _this.form.reset();

        _this.btn.innerHTML = 'Send';
        _this.btn.style.backgroundColor = '#000';
      }, 5000));
    }
  }, {
    key: "validateEmail",
    ...
    value: function sendData() {
      ...
      this.form.addEventListener('submit', function (event) {
        ...
        _this4.formData = new FormData(_this4.form);

        _this4.createRequest();
      });
    }
  }, {
    key: "ready",
